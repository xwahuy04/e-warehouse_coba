...
class SatuanWidget extends StatefulWidget {
  @override
  _SatuanWidgetState createState() => _SatuanWidgetState();
}

class _SatuanWidgetState extends State<SatuanWidget> {
  @override
  ...
  child: Container(
    ...
    decoration: BoxDecoration(
      ...
      bottomNavigationBar: CustomBottomNavbar(currentPage: 'Satuan'),
    );
  }
}
